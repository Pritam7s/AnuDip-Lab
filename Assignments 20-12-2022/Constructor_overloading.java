...
public class Constructor_overloading {
	...
	public static void main(String[] args) {
		...
		Employee employee2 = new Employee(2, "Pritam", "Trimohini", 987654321, "India", "West Bengal");
		//employee2.display();
		System.out.println(employee2);
		System.out.println();
		
		Employee employee3 = new Employee(3, "Proxym", "Barasat", 869635123, "India", "West Benagal", 35000, 987321654, "Developer");
